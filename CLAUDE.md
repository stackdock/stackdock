...
- The Gumroad scraper parses embedded React JSON; if it returns 0 purchases, the cookie expired or the frontend changed — its module docstring explains the fix. Prefer RSS feeds.
