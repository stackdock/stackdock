...
interface GridPaneServersTestPageProps {
    searchParams: Promise<{
        page?: string;
    }>;
}

export default async function GridPaneServersTestPage({ searchParams }: GridPaneServersTestPageProps) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-2 mt-4">
                        {serverData.meta.current_page > 1 && (
                            <a 
                                href={`?page=${serverData.meta.current_page - 1}`}
