...
export default async function GridPaneSystemUsersTestPage({ searchParams }: GridPaneSystemUsersTestPageProps) {
                                ...
                                <div key={user.id} className="bg-white p-4 rounded border">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">ID: {user.id} | Server: {user.server_id}</p>
                                        </div>
                                    ...
                                    {user.details && (
                                        <div className="mb-2">
                                            <p className="text-sm text-gray-700"><strong>Details:</strong> {user.details}</p>
                                        </div>
                                    )}
                                    ...
                                    {user.sites.length > 0 && (
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-1">
                                                {user.sites.map(site => (
                                                    <span key={site.id} className="px-2 py-1 bg-gray-100 text-gray-800 rounded text-xs">
                                                        {site.url}
                                                    </span>
                                                ))}
                                            </div>
